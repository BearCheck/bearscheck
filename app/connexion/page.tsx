      ...
      <main className="flex-1 flex items-center justify-center py-16 px-4 bg-[#FAFAFA]">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[#1A1A1A]">Connexion à votre compte</h1>
            <p className="text-sm text-[#6B7280] mt-2">Retrouvez vos devis sauvegardés</p>
          </div>
          ...
          <div className="bg-white border border-[#E5D8BC] rounded-2xl p-8 shadow-sm">
            ...
            <div className="relative my-5">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-[#E5D8BC]" />
              </div>
              <div className="relative flex justify-center">
                <span className="bg-white px-3 text-xs text-[#9CA3AF]">ou continuer avec</span>
              </div>
            </div>
          ...
          <p className="text-center text-xs text-[#9CA3AF] mt-4">
            ...
            <Link href="/pro/connexion" className="text-[#C9A84C] hover:underline">
              Espace pro →
            </Link>
          </p>
        </div>
